...
class ToolMode(Mode):
    def __init__(self, state, printer):
        ...
        self.components = [
            ...
            Button(self.state, (self.move_x + 80, self.move_y), (60, 60), "^", self.button_north_on_click),
            Button(self.state, (self.move_x, self.move_y + 80), (60, 60), "<", self.button_west_on_click),
            Button(self.state, (self.move_x + 80, self.move_y + 80), (60, 60), "H", self.button_home_on_click),
            Button(self.state, (self.move_x + 80 + 80, self.move_y + 80), (60, 60), ">", self.button_east_on_click),
            Button(self.state, (self.move_x + 80, self.move_y + 80 + 80), (60, 60), "v", self.button_south_on_click),

            Button(self.state, (self.move_x + 80 + 80 + 80, self.move_y), (60, 100), "^", self.button_up_on_click),
            Button(self.state, (self.move_x + 80 + 80 + 80, self.move_y + 120), (60, 100), "v", self.button_down_on_click),
