...
class TextComponent(Component):
    ...
    def make_surface(self):
        ...
        self.surface = self.get_new_surface((text_fg_surface.get_width() + offset, text_fg_surface.get_height() + offset))
        self.surface.blit(text_highlight_surface, (offset, offset))
        self.surface.blit(text_fg_surface, (0, 0))

        self.text_width = self.surface.get_width()
        self.text_height = self.surface.get_height()
    ...
    def render(self, surface):
        ...
        surface.blit(self.surface, (self.x + self.text_x, self.y + self.text_y))
